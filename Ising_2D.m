...
% 2D Ising Model for Magnetism

% Dogshit coding attempt

% lattice size = 30 x 30, N includes padded boundary for wrapping edges
N = 32;
...
% plot average energy vs iteration
figure
plot(1:t_max, E_avg, 'b-.')
xlabel('Average Energy Per Lattice Point')
ylabel('Iteration')